...
def _render_nav():
    ...
    for pat,lbl in [("pages/Bulk Analytics.py|pages/*[Bb]ulk*.py","\U0001f4ca Bulk Customer Analytics"), st.sidebar.markdown("<hr style='margin:8px 0 12px 0;'>",unsafe_allow_html=True)

                    ("pages/POSB Daily Report.py|pages/*[Pp][Oo][Ss][Bb]*.py","\U0001f4ee POSB Daily Report"), st.sidebar.markdown("<hr style='margin:8px 0 12px 0;'>",unsafe_allow_html=True)

                    ("pages/1_Digital_Transactions.py|pages/*[Dd]igital*.py","\U0001f4bb Digital Transactions"), st.sidebar.markdown("<hr style='margin:8px 0 12px 0;'>",unsafe_allow_html=True)
